  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 12),
        TransactionContainer(title: "Cash Withdrawal", subTitle: "13 Apr, 2022 ", salary: r"$20,129"),
        SizedBox(height: 10),
        TransactionContainer(title: "Landing Page project", subTitle: "13 Apr, 2022 at 3:30 PM", salary: r"$2,000"),
        SizedBox(height: 10),
        TransactionContainer(title: "Juni Mobile App project", subTitle: "13 Apr, 2022 at 3:30 PM", salary: r"$20,129",color: Colors.red,),
        SizedBox(height: 10),
      ],
    );
  }
